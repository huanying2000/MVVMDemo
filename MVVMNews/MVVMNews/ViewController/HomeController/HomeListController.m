...
@interface HomeListController ()<UITableViewDelegate,UITableViewDataSource,iCarouselDelegate,iCarouselDataSource>
...
- (UIView *)configHeadView {
    ...
    UIView *headView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 0, LFSCREENWIDTH*375/750)];
...
- (UIView *)carousel:(iCarousel *)carousel viewForItemAtIndex:(NSInteger)index reusingView:(UIView *)view {
    if (!view) {
        view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, LFSCREENWIDTH, LFSCREENWIDTH*375/750)];
